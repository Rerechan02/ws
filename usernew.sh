...
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
echo -e "OpenVPN Config : http://$domen:81/" | tee -a /etc/log-create-user.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
...
echo -e "    <=  SSH ACOUNT  =>"        | tee -a /etc/log-create-user.log
echo -e "══════════════════════════"                  | tee -a /etc/log-create-user.log
echo -e "" | tee -a /etc/log-create-user.log
echo -e "Username     : $Login" | tee -a /etc/log-create-user.log
echo -e "Password     : $Pass"         | tee -a /etc/log-create-user.log
echo -e "ISP          : $( curl -s ipinfo.io/org )" | tee -a /etc/log-create-user.log
echo -e "Host/IP      : $(cat /etc/xray/domain)" | tee -a /etc/log-create-user.log
echo -e "Port ws ssl  : 443" | tee -a /etc/log-create-user.log
echo -e "Port ws http : 80"                       | tee -a /etc/log-create-user.log
