...
echo -e "     ${BICyan}[${BIWhite}10${BICyan}] DNS CANGER ${BICyan}${BIYellow}${BICyan}${NC}"   
...
echo -e "     ${BICyan}[${BIWhite}66${BICyan}] TENDANG ${BICyan}${BIYellow}${BICyan}${NC}"
echo -e "     ${BICyan}[${BIWhite}77${BICyan}] CHECK RAM ${BICyan}${BIYellow}${BICyan}${NC}" 
