...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/Rerechan02/ws/main/password"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/Rerechan02/ws/main/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Rerechan02/ws/main/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/Rerechan02/ws/main/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/Rerechan02/ws/main/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Rerechan02/ws/main/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear
cat> /etc/issue.net << END
<font color="red"><b>============================</b></font><br> 
<font color="white"><b>  AUTOSCRIPT BY RERECHAN02</b></font><br> 
