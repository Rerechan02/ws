...
echo -e "    <=  VMESS ACCOUNT =>"        | tee -a /etc/log-create-user.log
echo -e "══════════════════════════"                  | tee -a /etc/log-create-user.log
echo -e ""                 | tee -a /etc/log-create-user.log
...
echo -e "Path 0P0K    : /kuota-habis, /worryfree"                     | tee -a /etc/log-create-user.log
echo -e "serviceName  : vmess-grpc"                | tee -a /etc/log-create-user.log
echo -e ""   | tee -a /etc/log-create-user.log
echo -e "══════════════════════════"                 
echo -e "Link Tls  => ${vmesslink1}" | tee -a /etc/log-create-user.log
echo -e "══════════════════════════"                  | tee -a /etc/log-create-user.log
echo -e "Link None => ${vmesslink2}" | tee -a /etc/log-create-user.log
echo -e "══════════════════════════"                  | tee -a /etc/log-create-user.log
