...
echo -e "${cyan}======================================${off}"
echo -e "${green}"
echo -e " 01⸩ View Total Bandwidth Remaining"

echo -e " 02⸩ Usage Table Every 5 Minutes"

echo -e " 03⸩ Hourly Usage Table"

echo -e " 04⸩ Daily Usage Table"

echo -e " 05⸩ Monthly Usage Table"

echo -e " 06⸩ Annual Usage Table"

echo -e " 07⸩ Highest Usage Table"

echo -e " 08⸩ Hourly Usage Statistics"

echo -e " 09⸩ View Current Active Usage"
